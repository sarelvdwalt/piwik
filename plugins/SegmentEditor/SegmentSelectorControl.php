...
class SegmentSelectorControl extends UIControl
{
    ...
    private function getTranslations()
    {
        $translationKeys = array(
            ...
            'General_OperationContainsCaseInsenstive',
            'General_OperationDoesNotContainCaseInsenstive',
            'General_OperationIs',
            'General_OperationIsNot',
            'General_OperationContainsCaseInsensitive',
            'General_OperationDoesNotContainCaseInsensitive',
